/*global expect, it, describe, MashupPlatform, MockMP, checkEqual, calculate_complement, beforeAll, afterAll, beforeEach*/
(function () {
    "use strict";
    ...
    describe("Test SetDifferenceList", function () {
        ...
        describe ("Should calculate the difference of two lists", function() {
            it("Should return listA if listB is empty", function () {
                var listA = [1, 2, 3];
                var listB = [];

                expect(calculate_complement(listA, listB)).toEqual(listA);
            });

            it("Should return listB if listA is empty", function () {
                var listA = [];
                var listB = [1, 2, 3];

                expect(calculate_complement(listA, listB)).toEqual(listB);
            });
            ...
            it("Should work with number lists", function (){
                ...
                expect(calculate_complement(listA, listB)).toEqual(result);
            });

            it("Should work with string lists", function (){
                var listA = ["hello", "world"];
                var listB = ["hello", "bye"];
                var result = ["world", "bye"];
            ...
            it("Should work with object lists", function (){
                ...
                var result = [{text: "world"}, {text: "bye"}];
            ...
            it("Should work with mixed lists", function (){
                ...
                var result = [1, {text: "world"}, 4, {text: "bye"}, "world"];
